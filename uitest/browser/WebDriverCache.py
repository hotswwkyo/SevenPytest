...
from uitest.utils import StringKeyDict
from uitest.exceptions import NoOpenDriver
...
class WebDriverCache(object):
    ...
    def active_drivers(self):
        ...
        for driver in self._all_drivers:
            if dirver not in self._closed_drivers:
                open_drivers.append(dirver)
        return open_drivers
    ...
    def __nonzero__(self):
        ...
        return self._current_driver != None and isinstance(self._current_driver, RemoteWebDriver)
